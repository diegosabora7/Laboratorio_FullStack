...
public class TaskService {
    ...
    // TODO: [LABORATORIO - BUG 1] - N+1 queries: se cargan TODAS las tareas con findAll() y se filtran en memoria.
    // Además, toResponse() hace una llamada HTTP individual al user-service por cada tarea (N+1 al servicio externo).
    @Cacheable(value = "tasksByProject", key = "#projectId")
    @Transactional(readOnly = true)
    public List<TaskResponse> getByProject(Long projectId) {
        //System.out.println("🚨 [BUG 1] Ejecutando findAll() - cargando TODAS las tareas de TODOS los proyectos...");
        ...
        //System.out.println("🚨 [BUG 1] Total tareas cargadas en memoria: " + allTasks.size() + " (solo necesitamos las del proyecto " + projectId + ")");
    ...
    public TaskResponse create(TaskRequest request) {
        ...
        // TODO: [LABORATORIO - BUG 4] - Cache stale: se crea una tarea pero no se invalida la caché de tasksByProject ni tasks.
        Task saved = taskRepository.save(task);
        return toResponse(saved);
    }

    // TODO: [LABORATORIO - BUG 4] - Cache stale: falta @CacheEvict. Los datos en caché quedan desactualizados hasta que expire el TTL (~5 min).
    // TODO: [LABORATORIO - BUG 2] - Race condition: no se usa optimistic locking. Dos usuarios pueden actualizar simultáneamente y uno pierde su cambio.
    @Transactional
    @CacheEvict(value = {"tasks", "tasksByProject"} , allEntries = true)
    public TaskResponse updateStatus(Long id, String status) {
        ...
        // TODO: [LABORATORIO - BUG 2] - Race condition: no hay verificación de versión. El último en escribir gana silenciosamente.
    ...
    // TODO: [LABORATORIO - BUG 1] - N+1 queries: cada llamada a toResponse() dispara una petición HTTP al user-service para obtener el nombre del asignado.
    ...
    // TODO: [LABORATORIO - BUG 3] - Fallo en cascada: si user-service está caído, esta llamada bloquea y falla toda la operación.
